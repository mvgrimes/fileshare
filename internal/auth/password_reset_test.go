...
func (s *passwordResetQuerierStub) CreatePasswordReset(
	context.Context,
	db.CreatePasswordResetParams,
) error {
	return nil
}

func (s *passwordResetQuerierStub) ListPasswordResetsByActor(
	context.Context,
	string,
	string,
...
func (s *passwordResetQuerierStub) GetPasswordResetByTokenHash(
	context.Context,
	string,
) (db.PasswordReset, error) {
...
func (s *passwordResetQuerierStub) ConsumePasswordResetIfActive(
	context.Context,
	string,
) (bool, error) {
...
func (s *passwordResetQuerierStub) UpdateUserPasswordHashByID(
	_ context.Context,
	id string,
	hash sql.NullString,
) error {
...
func (s *passwordResetQuerierStub) UpdateClientPasswordHashByID(
	_ context.Context,
	id string,
	hash sql.NullString,
) error {
...
func TestPasswordResetConfirmUpdatesUserPassword(t *testing.T) {
	...
	if bcrypt.CompareHashAndPassword(
		[]byte(stub.updatedUserHash.String),
		[]byte("new-password-123"),
	) != nil {
